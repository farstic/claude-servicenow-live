...
5. **Apply the Domain Expert gateway.** Before routing to any builder specialist, check whether the task falls within a domain covered by a v2.0 Domain Expert gateway:
